...
namespace _20240816_DelegatesDemo
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            ArithmeticOperation op1 = new ArithmeticOperation(CalcSumma);    // присвоєння адреси методу в змінну типу делегат
            ...
            op1 = new ArithmeticOperation(CalcMult);    // присвоєння адреси методу в змінну типу делегат
            ...
            DoCalculate(agr1, arg2, new ArithmeticOperation(CalcMult));
            ...
            if (op2 != null) 
            {
                ...
                double result10 = op2.Invoke(agr1, arg2);
            }

            op2 = new ArithmeticOperation(CalcSumma);

            Console.WriteLine();
            Console.WriteLine();
            Console.ForegroundColor = ConsoleColor.Green;
            double result11 = op2.Invoke(agr1, arg2);
            Console.WriteLine("result11: {0}", result11);

            // += - перевантажений оператор для додавання методу в лнцюжок викликів
            //op2 += CalcMult;
            op2 = (ArithmeticOperation)Delegate.Combine(op2, new ArithmeticOperation(CalcMult));
            ...
            //op2 += CalcSumma;
            op2 = (ArithmeticOperation)Delegate.Combine(op2, new ArithmeticOperation(CalcMult),
                    new ArithmeticOperation(CalcSumma),
                    new ArithmeticOperation(CalcSumma), new ArithmeticOperation(CalcSumma));
            ...
            //op2 -= CalcSumma;
            //op2 = (ArithmeticOperation)Delegate.Remove(op2, new ArithmeticOperation(CalcSumma));
            op2 = (ArithmeticOperation)Delegate.RemoveAll(op2, new ArithmeticOperation(CalcSumma));
            Console.WriteLine();
            ...
            //op2 -= CalcMult;
            op2 = (ArithmeticOperation)Delegate.Remove(op2, new ArithmeticOperation(CalcMult));
            Console.WriteLine();
            Console.ForegroundColor = ConsoleColor.Magenta;
