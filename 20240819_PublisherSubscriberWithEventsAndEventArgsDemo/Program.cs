...
namespace _20240819_PublisherSubscriberDemo
{
    internal class Program
    {
        ...
        // обробники події 
        public static void NewIterationStaticHanler1(object sender, NewIterationEventArgs args)
        {
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("\t\tNewIterationStaticHanler1({0})", args.Iteration);
        }

        public static void NewIterationStaticHanler2(object sender, NewIterationEventArgs args)
        {
            Console.ForegroundColor = ConsoleColor.Magenta;
            Console.WriteLine("\t\tNewIterationStaticHanler2({0})", args.Iteration);
        }
    }
}
